...
sudo curl https://raw.githubusercontent.com/DoctorPok42/my_web/develop/nginx/intra.asrlab.lan >> sudo /etc/nginx/sites-available/intra.asrlab.lan
sudo curl https://raw.githubusercontent.com/DoctorPok42/my_web/develop/nginx/intra-adm.asrlab.lan >> sudo /etc/nginx/sites-available/intra-adm.asrlab.lan
